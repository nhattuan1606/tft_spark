...
# Run job about point
docker cp -L pyspark_job/point.py pysparkdocker_spark-master_1:/opt/spark/jobs/point_job.py
...
docker cp -L pysparkdocker_spark-master_1:/opt/spark/results/point_output.txt results/point_output.txt

# Run job about unit
docker cp -L pyspark_job/unit.py pysparkdocker_spark-master_1:/opt/spark/jobs/unit_job.py

docker-compose exec spark-master spark-submit --conf "spark.mongodb.read.connection.uri=mongodb+srv://root:1234@cluster0.dsjq879.mongodb.net/" --conf "spark.mongodb.write.connection.uri=mongodb+srv://root:1234@cluster0.dsjq879.mongodb.net/" --packages org.mongodb.spark:mongo-spark-connector_2.12:10.2.2 --master spark://spark-master:7077 jobs/unit_job.py

docker cp -L pysparkdocker_spark-master_1:/opt/spark/results/unit_output.txt results/unit_output.txt
